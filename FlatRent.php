...
<?php include('template/navbar.php');?>
    <div class="container">
        <h2 class="text-center py-4">Find Your Suitable Place To Rent</h2>
        <form action="FlatRent.php" method="POST">
        <div class="row py-3">
            <div class="col-sm-3">
    ...
    <div class="container">
        <?php
        $getHouse_sqlQuery="SELECT taglineDescription,flatRent,mainImage,availableDate,flatLocation
        FROM flat 
